<template>
    <div>
        ...
        <extended usage="b" fslug="photo-filters" :fid="fid"/>
        ...
        <div id="photo-effects" style="display: none">
            <ul id="filters">
                ...
                <button id='spaghetify' v-on:click="applySpaghetify"><img id="spaghetyFilter" src="dist/assets/img/spaghetification.jpg">
                ...
                <button id='gravitationalLens' v-on:click="applyGravitationalLens"><img id="gravitationalLensFilter" src="dist/assets/img/uncertanty.jpg">
                ...
                <button id='entanglement' v-on:click="applyEntanglement"><img id="entanglementFilter" src="dist/assets/img/normal.jpg">
    ...
    export default {
        ...
        data: function() {
            return {
                ...
                video: {},
                canvas: {},
                filters: ['normal', 'spaghetify', 'redShift', 'uncertainty', 'gravitationalLens', 'UV', 'chalkboard', 'entanglement']
            }
        },
        created: function () {
        ...
        methods: {
            ...
            fitImageOn(incomingImage, referenceImage) {
                return new Promise((resolve) => {
                    ...
                    console.log(incomingImgAspectRatio, referenceImgAspectRatio);
...
*/
            ...
            spaghetify(incomingImage, outgoingImage) {
                return new Promise((resolve,reject) => {                    
                    ...
                    var spritespaghety = new PIXI.Sprite(new PIXI.Texture.from(incomingImage));
                    spritespaghety.setTransform(-(incomingImage.height * 2 - incomingImage.width) / 2,0,incomingImage.height/incomingImage.width * 2, 1, 0,0,0,0,0)
                    var containerspaghety = new Container()
                    containerspaghety.addChild(spritespaghety);
                    containerspaghety.filters = [fltr];
                    this.app.render(containerspaghety);
            ...
            applySpaghetify() {
                console.log("applySpaghetify Documents")
            ...
            getInfo: function () {
                axios.get(ajaxBaseURL + 'index.php?rest_route=/poi/v1/interactive-props/' + this.slug).then(response => {
                    var filter = response.data.prop_1
                    if(this.filters.includes(filter)) this.filterValue = filter;
                    else this.filterValue = 'normal';
                })
            }, 
