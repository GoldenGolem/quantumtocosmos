<template>
    <div>
        <div class="landing" v-show="firstVisit">
            <div class="pi-branding">
                  <a href="https://www.perimeterinstitute.ca/" target="_blank">
                    <svg width="30px" height="30px" viewBox="0 0 30 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                      <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                          <path d="M26.5361446,27.3760933 C26.5963855,29.1253644 29.2168675,29.1836735 29.5783133,29.1836735 C30.0301205,29.1836735 30,29.9708455 29.6385542,29.9708455 C29.2771084,29.9708455 19.6084337,29.9708455 19.246988,29.9708455 C18.9156627,29.9708455 18.8554217,29.1836735 19.3072289,29.1836735 C19.7289157,29.1836735 22.1686747,29.0962099 22.3192771,27.3760933 C22.3795181,26.4431487 22.4698795,13.9650146 22.4698795,5.10204082 C19.6987952,5.10204082 19.1566265,5.10204082 16.3855422,5.10204082 C19.6084337,6.32653061 21.2650602,8.4548105 21.2048193,11.1661808 C21.1144578,14.8688047 18.9457831,16.7346939 17.6807229,17.3760933 C15.3614458,18.5714286 10.9638554,18.9212828 7.68072289,18.7172012 C7.68072289,22.5947522 7.65060241,26.3556851 7.68072289,27.3177843 C7.74096386,29.212828 10.2710843,29.154519 11.0542169,29.212828 C11.4759036,29.2419825 11.4759036,30 11.0542169,30 C10.6325301,30 0.662650602,30 0.240963855,30 C-0.0602409639,30 -0.120481928,29.212828 0.301204819,29.212828 C0.722891566,29.212828 3.64457831,29.271137 3.79518072,27.4052478 C3.88554217,26.2390671 3.85542169,8.13411079 3.79518072,6.44314869 C3.73493976,4.40233236 0.78313253,4.48979592 0.361445783,4.40233236 C-0.0602409639,4.34402332 0.0602409639,3.61516035 0.361445783,3.61516035 C0.361445783,3.61516035 29.2771084,3.61516035 29.6987952,3.61516035 C30.1204819,3.61516035 30.060241,4.28571429 29.7590361,4.37317784 C29.4578313,4.43148688 26.5361446,4.43148688 26.5361446,6.26822157 C26.5662651,7.696793 26.5060241,26.6472303 26.5361446,27.3760933 Z M7.80120482,5.24781341 C7.80120482,5.24781341 7.74096386,17.2303207 7.74096386,17.4052478 C9.18674699,17.3469388 11.626506,17.3760933 12.8313253,16.9387755 C15.060241,16.122449 17.2891566,14.606414 17.2590361,10.9912536 C17.2590361,8.86297376 15.5722892,6.79300292 13.8253012,6.06413994 C12.2891566,5.42274052 10.3313253,5.24781341 8.01204819,5.21865889 L7.80120482,5.24781341 Z M14.9698795,0 L22.8012048,2.09912536 L7.13855422,2.09912536 L14.9698795,0 Z" id="pi-logo-svg" fill="#FFFFFF" fill-rule="nonzero"></path>
                      </g>
                    </svg>
                  </a>  
                </div>
            <div class="content">
                ...
                <h2>Welcome to the Scale of the Universe, a journey from quantum to cosmos</h2>
                <p>Scroll through to explore and discover interesting facts, images and interactions along the way by clicking on <i class='material-icons'>info</i> beside an item.
Look for this special icon <img src='/dist/assets/img/earth.png' width='14' height='14'> where distances from earth have been highlighted.
Start scrolling to begin your journey.</p>
                <button v-on:click="closeLanding">GET STARTED</button>
            </div>
        </div>
        ...
        <transition name="fade-up">
            <div class="jump-screen"  v-show="skipIn && notJumping">
                <div class="jump-screen__inner">
                    <div class="jump-screen__caption" v-bind:class="{ smallerText:smallerJumpLabelText }" v-bind:style="{ color : this.currentTextColor }" v-html="jumpString"></div>
...
<script>
    ...
    export default {
            ...
            return {
                ...
                tourSteps: [
                  
                  {
                    ...
                    content: "To navigate faster, use the + - zoom keys.",
                    params: {
                      placement: 'left'
                    }
                  },
                  {
                    ...
                    content: "Looking for something?  Find it here and jump right to it.",
                    params: {
                      placement: 'right'
                    }
                  },
                  ...
                  },
                  {
                    ...
                    content: "Enjoy exploring the universe.",
                    params: {
                      placement: 'top'
                    }
                  }
        ...
        mounted: function () {
            console.log('mounted',this.elementsNr)


            if(this.$cookie.get('scale_landing_seen')){
        ...
        methods: {
            changeJumpText: function(){
                ...
                this.smallerJumpLabelText = false;
                if(this.currentScale < -20 && this.currentScale > -30){
                    
                    this.jumpString = "Although scientists have discovered a lot about the universe, many mysteries remain.<br><br>One of them is what—if anything—exists in this part of the scale. We don’t have microscopes that can see this small. So we haven’t observed anything here yet. <br>But it isn’t just about lacking the technology. Our current scientific models predict that there might not even be much to look for. They suggest a puzzling gap at this part of the scale for which there must be a reason. Scientists call the riddle of why there’s a gap the hierarchy problem. It’s one of the biggest unsolved mysteries in science today. <br><br>Scroll through to see the size of this void, or JUMP to the next item on the scale."
                    this.smallerJumpLabelText = true;
                }
            },            
            init() {
                console.log('has latest version of js')
                let thisApp = this
                console.log("init:",this.$route.query.value)
                if(this.$route.query.value != undefined){
                    console.log("passed inisde if");
                ...
                for (let i = this.elementsNr-1; i >= 0; i--) {
                    ...
                    if(obj.type!="simple"){                       
                        ...
                        item.icon.click = function(e) {                            
                            //thisApp.singleOutElement(this.parent.parent)
                            thisApp.$root.itemAction(this.parent.parent.obj)
            ...
            closeLanding(){
                this.firstVisit = false;
                this.$cookie.set('scale_landing_seen', 'One year later', { expires: '1Y' });
            },
            rgbToHex(r, g, b) {
